...
public record ColunasCarvaoDTO(Long id, Double pressao_c01, Double pressao_c02, Double pressao_c03, Double pressao_saida, Boolean houve_troca_carvao, Boolean houve_retrolavagem, Ponto ponto) {
